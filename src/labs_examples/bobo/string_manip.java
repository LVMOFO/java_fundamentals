...
public class string_manip {
    class Main {
        public static void main(String[] args) {
            ...
            // BoCode Take first and last and say upsidedown Hi
            int iLength = str1.length();
            char cFirstChar = str1.charAt(iLength -1);
            char cLastChar = str1.charAt(0);
            System.out.println("Upside down Hi = " + cFirstChar + cLastChar);
